...
function DefaultArrayItem(props) {
  ...
  return (
    <div key={props.index} className={props.className}>
      <div className={props.hasToolbar ? "ant-col-xs-18" : "ant-col-xs-24"}>
        {props.children}
      </div>

      {props.hasToolbar && (
        <div className="ant-col-xs-6 array-item-toolbox">
          <Button.Group
            style={{
              display: "flex",
...
function DefaultFixedArrayFieldTemplate(props) {
  return (
    <Row className={props.className} id={props.idSchema.$id}>
      <ArrayFieldTitle
